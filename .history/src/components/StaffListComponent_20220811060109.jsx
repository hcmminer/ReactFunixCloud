...
const StaffListComponent = ({ screen }) => {
    ...
    console.log("🚀 => file: StaffListComponent.jsx => line 15 => StaffListComponent => deleteStatus", deleteStatus)
    ...
    useEffect(() => {
        const getStaffs = async () => {
            try {
                ...
                console.log("🚀 => file: StaffListComponent.jsx => line 22 => getStaffs => res", res.data)
            } catch (err) {
                console.log(err);
            }
        };
