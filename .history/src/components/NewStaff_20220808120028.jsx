...
import { staffNew } from "../redux/staffsRedux";
...
const NewStaff = ({ setIsNewStaffForm }) => {
    ...
    const FormikApp = withFormik({
        ...
        validationSchema: Yup.object().shape({
            ...
            image: Yup.mixed().required("Image is required").test("fileSize", "The file is too large", (value) => {
        ...
        handleSubmit(values, { resetForm, setErrors, setSubmitting }) {
            setTimeout(() => {
                if (Boolean(staffs.find((item) => item.id == values.id))) {
                    ...
                    try {
                        const res = publicRequest.post("staffs", values);
                        resetForm();
