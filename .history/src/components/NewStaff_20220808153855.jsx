...
const NewStaff = ({ setIsNewStaffForm }) => {
    ...
    const [imagePath, setImageRelativePath] = useState(
        "/assets/images/alberto.png"
    );
    console.log(
        "🚀 => file: NewStaff.jsx => line 19 => NewStaff => imageRelativePath",
        imageRelativePath
    );
                        ...
                        <div>
                            <div className="">
                                ...
                                <Field
                                    ...
                                    name="image"
                                    onChange={(e) =>
                                        setImageRelativePath(e.target.files[0])
                                    }
                                    placeholder="image"
                                />
                            </div>
        ...
        handleSubmit(values, { resetForm, setErrors, setSubmitting }) {
            setTimeout(() => {
                if (Boolean(staffs.find((item) => item.id == values.id))) {
                    ...
                    console.log(values.image.webkitRelativePath);
