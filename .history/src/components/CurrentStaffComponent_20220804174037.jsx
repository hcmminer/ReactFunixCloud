...
const CurrentStaffComponent = function () {
    ...
    console.log("🚀 => file: CurrentStaffComponent.jsx => line 25 => CurrentStaffComponent => currentStaff", currentStaff)
    const currentDepartment = departments.filter(
        (item) => item.id === currentStaff.departmentId
    )[0];
    console.log("🚀 => file: CurrentStaffComponent.jsx => line 29 => CurrentStaffComponent => currentDepartment", currentDepartment)
