            ...
            <div className=" bg-cyan-50 relative">
                ...
                <div className=" mx-6">
                            ...
                            >
                                <div className="relative group">
                                    ...
                                    <div className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden group-hover:block ">
                                        <div className="flex">
                                            <div className="mr-4 p-4 hover:text-blue-600 border-2 rounded-full hover:bg-black">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-6 w-6"
                                                    fill="none"
                    ...
                    <div className="pt-4 text-pink-500 italic text-lg">
                        Bấm vào ảnh nhân viên để xem thông tin Lorem ipsum dolor
                        sit amet consectetur adipisicing elit. Soluta recusandae
                        doloremque maiores sit expedita quae nostrum officiis!
                        Illum possimus temporibus, officia atque suscipit
                        obcaecati quibusdam asperiores placeat fugit ut amet?
                    </div>
                </div>
                <div
                    id="newstaff"
