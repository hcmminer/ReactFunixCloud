...
const CurrentStaffComponent = function () {
    ...
    console.log("🚀 ~ file: CurrentStaffComponent.jsx ~ line 11 ~ CurrentStaffComponent ~ departments", departments)
    ...
    console.log(
        "🚀 ~ file: CurrentStaffComponent.jsx ~ line 27 ~ currentStaff ~ currentStaff",
        currentStaff
    );
    ...
    console.log("🚀 ~ file: CurrentStaffComponent.jsx ~ line 103 ~ CurrentStaffComponent ~     const departments = useSelector((state) => state.staffs.departments);
",     const departments = useSelector((state) => state.staffs.departments);
)
