...
const CurrentStaffComponent = function () {
    ...
    const currentStaff = staffs.filter((item) => {
        ...
        console.log(
            "🚀 => file: CurrentStaffComponent.jsx => line 32 => currentStaff => item.id == parseInt(staffId, 10)",
            item.id === parseInt(staffId, 10)
        );
        console.log(
            "🚀 => file: CurrentStaffComponent.jsx => line 32 => currentStaff => parseInt(staffId, 10)",
            typeof parseInt(staffId, 10)
        );
        console.log(
