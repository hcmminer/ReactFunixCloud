...
const CurrentStaffComponent = function () {
    ...
    console.log("🚀 ~ file: CurrentStaffComponent.jsx ~ line 10 ~ CurrentStaffComponent ~ staffs", staffs)
    const departments = useSelector((state) => state.at.departments);
    console.log("🚀 ~ file: CurrentStaffComponent.jsx ~ line 12 ~ CurrentStaffComponent ~ departments", departments)
    ...
    console.log("🚀 ~ file: CurrentStaffComponent.jsx ~ line 28 ~ CurrentStaffComponent ~ currentStaff", currentStaff)
    const currentDepartment = departments.filter(
        (item) => item.id === currentStaff.departmentId
    )[0];
    console.log("🚀 ~ file: CurrentStaffComponent.jsx ~ line 30 ~ CurrentStaffComponent ~ currentDepartment", currentDepartment)
