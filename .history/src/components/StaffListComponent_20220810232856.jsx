        ...
        return (
            <div className=" bg-cyan-50 relative">
                ...
                <div className=" mx-6">
                                    ...
                                    <div className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden group-hover:block ">
                                        <div className="flex">
                                            <div
                                                ...
                                                className="mr-4 p-4 hover:text-blue-600 border-2 rounded-full hover:bg-black"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-6 w-6"
                    ...
                    <div className="">
                        Email: hcmminer@gmail.com Liên hệ quảng cáo:
                        0945.54.03.03 Email: quangcao@dantri.com.vn Đọc báo Dân
                        trí trên mobile: IOS Android Theo dõi Dân trí trên:
                        Facebook Youtube Tiktok © 2005-2022 Bản quyền thuộc về
                        Báo điện tử Dân trí. Cấm sao chép dưới mọi hình thức nếu
