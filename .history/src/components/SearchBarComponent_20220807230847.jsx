...
import { staffsGeted, staffsSearched } from "../redux/staffsRedux";
    ...
    useEffect(() => {
        const getStaffs = async () => {
            try {
                ...
                const a =await setTimeout(()=> console.log(Math.pow(7,100)),2000)
                const b = setTimeout(()=> console.log(Math.pow(7,1)),1000)
            } catch (err) {
                console.log(err);
            }
        };
