...
const CurrentStaffComponent = function ({ page }) {
    ...
    console.log(
        "🚀 => file: CurrentStaffComponent.jsx => line 35 => CurrentStaffComponent => currentStaff",
        currentStaff
    );
    ...
    console.log("🚀 => file: CurrentStaffComponent.jsx => line 43 => CurrentStaffComponent => currentDepartment", currentDepartment)
    let linkName;
    let linkUrl;
    if (page == "staffs") {
        linkName = "Nhân viên";
    ...
    //hahahahaha :D
    if (currentStaff != undefined && currentDepartment != undefined) {
        return (
            <>
