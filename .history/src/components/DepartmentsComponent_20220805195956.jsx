...
const DepartmentsComponent = () => {
    ...
    useEffect(() => {
        const getDepartments = async () => {
            try {
                const res = publicRequest.get("/departments");
                console.log("🚀 => file: DepartmentsComponent.jsx => line 28 => getDepartments => res", (await res).data)
                
                useDispatch()(departmentsGeted(res.data));
            } catch (error) {}
        };
        getDepartments();
    }, []);
