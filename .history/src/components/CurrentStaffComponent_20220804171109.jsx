...
const CurrentStaffComponent = function () {
    ...
    console.log(
        "🚀 => file: CurrentStaffComponent.jsx => line 11 => CurrentStaffComponent => departments",
        departments
    );
    ...
    console.log(staffs);
    const currentStaff = staffs.filter((item) => {
        item.id == parseInt(staffId, 10);
        console.log("🚀 => file: CurrentStaffComponent.jsx => line 32 => currentStaff => item.id == parseInt(staffId, 10)", item.id == parseInt(staffId, 10))
        console.log("🚀 => file: CurrentStaffComponent.jsx => line 32 => currentStaff => parseInt(staffId, 10)",typeof  parseInt(staffId, 10))
        console.log(
            "🚀 => file: CurrentStaffComponent.jsx => line 33 => currentStaff => item",
            typeof item.id
        );
    })[0];
