...
const NewStaff = ({
    ...
    const a =new Date(currentStaffEdit.doB)
    console.log("🚀 => file: NewStaff.jsx => line 24 => a", a)
    console.log(
        "🚀 => file: NewStaff.jsx => line 23 => currentStaffEdit",
        currentStaffEdit
    );
    useEffect(() => {
        ...
        mapPropsToValues({
            ...
            if (idStaffEdit) {
                return {
                    ...
                    doB: new Date(currentStaffEdit.doB),
