                    ...
                    <div className={resString}>
                        {staffs.map((item, key) => (
                            <div
                                ...
                                key={key}
                            >
                                <div className="relative group hover:opacity-5">
                                    <Link
                                        to={`/staffs/${item.id}`}
                                        className=""
                                    >
                                    ...
                                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden group-hover:block hover:bg-opacity-100">
                                        <div className="flex">
                                            <div className="mr-4 hover:text-pink-600 border-2 rounded-full hover:opacity-100">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-6 w-6"
                                                    fill="none"
