            ...
            <div className=" bg-cyan-50 relative">
                ...
                <div className=" mx-6">
                            ...
                            >
                                <div className="relative group">
                                    ...
                                    <div className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden group-hover:block ">
                                        <div className="flex">
                                            <div  onClick={() => setIsNewStaffForm("")} className="mr-4 p-4 hover:text-blue-600 border-2 rounded-full hover:bg-black">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-6 w-6"
                                                    fill="none"
                                            ...
                                            <div className="p-4 hover:text-red-500 border-2 rounded-full hover:bg-black">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-6 w-6"
                                                    fill="none"
                    ...
                    <div>
                        ...
                        elit. Ad deleniti id nemo molestias voluptate itaque
                        quas corporis, saepe assumenda veritatis cum, ipsum
                        architecto magni quasi iste qui consequuntur officiis
                        quisquam?
                    </div>
                </div>
                <div
                    id="newstaff"
                    className={`${isNewStaffForm} absolute bg-gray-400 top-0 left-1/2 transform -translate-x-1/2 z`}
                >
