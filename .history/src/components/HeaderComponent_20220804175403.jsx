...
import { staffsSorted } from "../redux/salariesPageRedux";

const HeaderComponent = ({ setScreen }) => {
    const dispatch = useDispatch();
    const [sort, setSort] = useState("default");
    const [currentSearchInput, setCurrentAearchInput] = useState("");
    ...
    if (activeLink == "/staffs") {
        ...
        rightMenu = (
            <div className="sm:col-span-2 hidden md:flex items-center justify-end">
                <select
                    onChange={(e) => {
                        dispatch(staffsSorted(e.target.value));
