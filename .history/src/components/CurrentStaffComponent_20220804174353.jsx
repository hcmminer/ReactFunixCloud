...
const CurrentStaffComponent = function () {
    ...
    console.log(
        "🚀 => file: CurrentStaffComponent.jsx => line 25 => CurrentStaffComponent => currentStaff",
        currentStaff
    );
    ...
    console.log(
        "🚀 => file: CurrentStaffComponent.jsx => line 29 => CurrentStaffComponent => currentDepartment",
        currentDepartment
    );
