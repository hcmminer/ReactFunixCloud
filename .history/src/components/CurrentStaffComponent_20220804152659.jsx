...
const CurrentStaffComponent = function () {
    ...
    console.log(
        "🚀 ~ file: CurrentStaffComponent.jsx ~ line 10 ~ CurrentStaffComponent ~ staffs",
        staffs
    );
    const departments = useSelector((state) => state.staffs.departments);
    console.log(
        "🚀 ~ file: CurrentStaffComponent.jsx ~ line 12 ~ CurrentStaffComponent ~ departments",
        departments
    );
    ...
    console.log(
        "🚀 ~ file: CurrentStaffComponent.jsx ~ line 28 ~ CurrentStaffComponent ~ currentStaff",
        currentStaff
    );
    ...
    console.log(
        "🚀 ~ file: CurrentStaffComponent.jsx ~ line 30 ~ CurrentStaffComponent ~ currentDepartment",
        currentDepartment
    );
